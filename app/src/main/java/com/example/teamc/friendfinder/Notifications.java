...
//    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        String[] menuItems = {"Lucy sends an interest to you", "Katie wants to initiate a chat",
                "You've received a message from Jade", "Jennie wants to meetup at Starbucks,"};

        ListView lv = (ListView) view.findViewById(R.id.myNotifications);
